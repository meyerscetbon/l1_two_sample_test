...
columns_names = ["method","num_of_samples","L1_opt_J_ME",
                        "L1_grid_J_ME", "L1_opt_J_SCF", "L1_grid_J_SCF"]
...
for j in range(num_of_tests):
    ax.plot(num_samples_test,to_plot[:,j],label=labels[j],linestyle=linestyles[j],color=colors[j])
